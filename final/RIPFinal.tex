...
One area not addressed in this approach is the probabilistic component of the optimizer representation, which affords a means to represent and manage the uncertainty in the actions taken by the robot and the observation error in ball position.  
