...
BEGIN_EVENT_TABLE(WalkPlanTab, wxPanel)
EVT_COMMAND (wxID_ANY, wxEVT_RST_SLIDER_CHANGE, WalkPlanTab::OnSlider)
EVT_COMMAND (wxID_ANY, wxEVT_COMMAND_RADIOBOX_SELECTED, WalkPlanTab::OnRadio)
EVT_COMMAND (wxID_ANY, wxEVT_COMMAND_BUTTON_CLICKED, WalkPlanTab::OnButton)
EVT_COMMAND (wxID_ANY, wxEVT_COMMAND_CHECKBOX_CLICKED, WalkPlanTab::OnCheckBox)
END_EVENT_TABLE()

// Class constructor for the tab: Each tab will be a subclass of RSTTab
IMPLEMENT_DYNAMIC_CLASS(WalkPlanTab, RSTTab)

WalkPlanTab::WalkPlanTab(wxWindow *parent, const wxWindowID id,
...
// Handle Radio toggle
void WalkPlanTab::OnRadio(wxCommandEvent &evt) {
...
void WalkPlanTab::OnButton(wxCommandEvent &evt) {
...
void WalkPlanTab::OnCheckBox(wxCommandEvent &evt) {
...
void WalkPlanTab::OnSlider(wxCommandEvent &evt) {
...
void WalkPlanTab::RSTStateChange() {
	if (selectedTreeNode == NULL) {
		return;
	}
